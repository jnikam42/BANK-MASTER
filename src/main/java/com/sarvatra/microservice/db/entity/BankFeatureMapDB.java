...
@Entity
@Table(name = BankFeatureMapDB.TABLE_NAME)
public class BankFeatureMapDB {

    public static final String TABLE_NAME = "INT_BANK_FEATURE_MAP";
    ...
    public Long getProductMapId() {
        return productMapId;
    }

    public void setProductMapId(Long productMapId) {
